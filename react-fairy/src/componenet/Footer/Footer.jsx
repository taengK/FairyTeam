        ...
        <ul>
            <li>
              <div className='footerLeftBox'>
                ...
                <p><i className="fa-solid fa-location-dot icon1"></i>sangmu Road, Sangmu 1205</p>
                <p><i className="fa-solid fa-phone"></i>+82 62 123 1234</p>
                <p><i className="fa-solid fa-envelope"></i>hermes@gmail.com</p>
            ...
            <li>
              <h3>DROP A MESSAGE</h3>
                <form>
                  ...
                  <input type="submit" value="S E N D" className="input3"/>
              </form>
            </li>
        </ul>
    </div>
